...
class VendorProductController extends Controller
{
    public function VendorAllProduct(){
        ...
        return view('vendor.product.vendor_product_all',compact('products'));
    } // End Method
    ...
    public function VendorAddProduct(){
        ...
        return view('vendor.product.vendor_product_add',compact('brands','categories'));
    ...
    public function VendorEditProduct($id){
        ...
        return view('vendor.product.vendor_product_edit',compact('brands','categories', 'products','subcategory','multiImgs'));
    }// End Method 
