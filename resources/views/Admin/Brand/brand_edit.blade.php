    ...
    <div class="container">
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form id="myForm" method="post" action="{{ route('add.brand.store') }}" enctype="multipart/form-data" >
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-3">
                                ...
                                <input type="hidden" name="old_image" value="{{$brandData->id}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{(!empty($brandData->brand_image)) ? url($brandData->brand_image) : url('upload/no_image.jpg')}} " alt="Admin"  style="width:100px; height:100px;">
