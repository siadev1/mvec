...
<div class="card">
  <div class="card-body p-4">
    ...
    <div class="form-check">
        ...
        <input class="form-check-input" name="featured" type="checkbox" value="1" id="flexCheckDefault" {{ $products->featured == 1 ? 'checked' : '' }}>			<label class="form-check-label" for="flexCheckDefault">Featured</label>
		</div>
	</div>
...
<div class="page-content">
    ...
    <hr>
    <div class="card">
        <form id="myForm" method="post" action="{{ route('product.update.thumbnail') }}" enctype="multipart/form-data" >
            @csrf
            <div class="card-body">
				<input type="hidden" name="id" value="{{ $products->id }}">
    			<input type="hidden" name="old_img" value="{{ $products->product_thambnail}}">
